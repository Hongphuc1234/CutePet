                ...
                <div class="info col-sm-12 col-md-12  col-lg-12 col-xl-8 col-12 col-xxl-8" style="background-color: white;">
                    ...
                    <h3 style="color:red">${message}</h3>
                        ...
                        <div class="txt-field">
                            ...
                            <input name="Description" type="text"  value="${p.description}" placeholder="Mô tả" required>
                        </div>
                        <div class="txt-field">
                            <p class="field-name-description" style="width:100px">Số Lượng:</p>
                            <input name="status" type="text" value="${p.status}" placeholder="Số Lượng" required>
                        </div>
