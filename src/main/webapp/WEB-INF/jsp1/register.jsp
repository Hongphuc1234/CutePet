...
<body>
    <div class="main">
        ...
        <div class="main_container" style="background-image: linear-gradient(0, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)),url(<c:url value="/resources/image/background.png" />)">
            <form action="${pageContext.request.contextPath}/saveee" method="POST" class="form" id="form-1" modelAttribute="RigisterForm">
                ...
                <div class="form-group">
                    ...
                    <input id="fullname" name="Customername" value="${param.Customername }"type="text" placeholder="VD: Nguyễn Hữu Phước"
                        class="form-control1">
                ...
                <div class="form-group">
                    ...
                    <input id="username" name="Username" value="${param.Username}" type="text" placeholder="VD: phuocfsoft2001"
                        class="form-control1">
                    <i class="fa-solid fa-user form-user"></i>
                    <span class="form-message"></span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="phone" name="Phone" value="${param.Phone}" type="text" placeholder="VD: 0702738234" class="form-cotrol1">
                    <i class="fa-solid fa-user form-user"></i>
                    <span class="form-message"></span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="password" name="Pass" value="${param.Pass}" type="password" placeholder="Nhập mật khẩu"n
                        class="form-control1">
                ...
                <div class="form-group">
                    ...
                    <i class="fa-solid fa-user-lock form-lock"></i>
                    <span class="form-message"></span>
                    <span class="show-btn2"><i class="fas fa-eye form-eye-confirm"></i></span>
                </div>
