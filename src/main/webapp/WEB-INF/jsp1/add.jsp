        ...
        <div class="content container reponsive" style="font-size: 1.6rem;">
            <div class="row">
                <div class="profile col-sm-12 col-md-12  col-lg-12 col-xl-4 col-12 col-xxl-4">
                    ...
                    <li class="account"><a href="<c:url value="profile?AccountID=${sessionScope.accA.accountID}"/>">
                ...
                <div class="info col-sm-12 col-md-12  col-lg-12 col-xl-8 col-12 col-xxl-8" style="background-color: white;">
                    <h2>Đăng bài</h2>
                    <form action="${pageContext.request.contextPath}/saveAdd" method="POST" modelAttribute="productForm">
                    ...
                    <h3 style="color:green">${messages}</h3>
                        <div class="txt-field">
                            ...
                            <input name="ProductnameA" type="text" placeholder="Nhập tên" required >
                        </div>
                        <div class="txt-option">
                            <p class="field-name" style="width:60px">Thể loại: </p>
                            <select name="CategoryID"  id="" class="option-category" required>
                        ...
                        <div class="txt-field">
                            ...
                            <input name="PriceA" type="number" placeholder="Nhập giá" required>
                        </div>
                         <div class="txt-field">
                            <p class="field-name"style="width:100px">Nhập số lượng:</p>
                            <input name="soluong" type="number" placeholder="Nhập số lượng" required>
                        </div>
                        <div class="txt-field" >
                            <p class="" style="width:100px">Thêm ảnh:</p><input style="border:none" type="file" name="imgA">
                        </div>
                        <div class="txt-field">
                            <p class="field-name-description" style="width:100px">Mô tả:</p>
                            <input name="DescriptionA" type="text" placeholder="Mô tả" required>
                        </div>
