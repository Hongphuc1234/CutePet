...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #FFC0CB; margin-bottom: 5%;">
    ...
    <div class="container reponsive" style="font-size: 1.6rem;  border-radius: 18px;">
        <div class="row">
            <table class="table">
                <table class="table">
                <thead>
    ...
    <h3 class="back-home"><a class="back-home-link" href="<c:url value="listA" />">Back to Home</a></h3>
    
    <div class="footer" style="margin-top: 30px; position:fixed; bottom:0">
