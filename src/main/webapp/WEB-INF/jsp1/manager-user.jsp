            ...
            <div class="col-sm-12 col-md-12  col-lg-12 col-xl-4 col-12 col-xxl-4 left" style="margin-bottom: 3%;">
                ...
                <div class="left-content">
                    <div style="display: flex;">
                        ...
                        <a href="<c:url value="manager-user" />" style="text-decoration: none; color: unset;"><div class="fw-bold" style="margin-left: 10px;">Quản lí người dùng</div></a>
                    </div>
                    <div style="display: flex; margin-top: 5%;">
                        <i class="fa-solid fa-note-sticky"></i>
                        <a href="<c:url value="manager-topic" />" style="text-decoration: none; color: unset;"><div style="margin-left: 16px;">Quản lí bài đăng</div></a>
                    </div>
                </div>
            </div>
