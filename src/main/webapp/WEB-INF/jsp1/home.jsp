...
<link rel="stylesheet"
	...
	<link rel="stylesheet"
	href="<c:url value="/resources/css/drop_down.css" />">
...
<body>
	...
	<div class="main"
		style="background-image: linear-gradient(0, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)),url(<c:url value="/resources/image/background.png"/> );">
		...
		<div class="container reponsive"
            style="border: 4px solid #ffb2c0; border-radius: 15px; padding-bottom: 20px; background-color: white; font-size: 1.6rem">
            <div class="row">
                <h2 style="text-align: center; margin-top: 10px; font-size: 22px;">Bài đăng mới</h2>
                ...
                <div class="col-xl-3 col-xxl-3 col-lg-4 col-md-8 col-sm-8 col-12" >
                    <div class="card text-center card-product" >
                        ...
                        <div style="padding: 4px;">
                             <p class="text-decoration-none card-description-p" style="color: #888; font-size: 16px; font-weight: 500; margin-top: 10px;">${pron.productname}</p>
                                <p class="card-price"  style="font-weight:500; font-size: 18px; color: #fe8fa4; margin-top: 10px;">${pron.price}</p>
                                <p class="text-decoration-none card-description-p" style="margin-top: 10px; font-size: 16px; font-style: italic"> ngày đăng : ${pron.datatime}</p>
                        </div>
                        <button class="btn btn-detail">
                            <a href="<c:url value="detail?pid=${pron.productID}"/>" style="text-decoration: none; font-weight:500; color: #000;">Xem chi tiết</a>
                        </button>
                    </div>
        ...
        <div class="container"
            style="border: 4px solid #ffb2c0; border-radius: 15px; margin-top: 30px;padding-bottom: 20px; background-color:#fff;">
            <h2 style="text-align: center; margin-top: 10px; font-size: 22px;">Sản Phẩm</h2>
            <div class="row">
                <c:forEach var="pro" items="${product}">
                    <div class="col-xl-3 col-xxl-3 col-lg-4 col-md-8 col-sm-8 col-12">
                        <div class="card text-center card-product">
                            ...
                            <div style="padding: 4px;">
                                <p class="text-decoration-none card-description-p" style="color: #888; font-size: 16px; font-weight: 500; margin-top: 10px;">${pro.productname}</p>
                                <p class="card-price"  style="font-weight:500; font-size: 18px; color: #fe8fa4; margin-top: 10px;">${pro.price}</p>
                                <p class="text-decoration-none card-description-p" style="margin-top: 10px; font-size: 16px; font-style: italic"> ngày đăng : ${pro.datatime}</p>
                            </div>
                            <button class="btn btn-detail">
                                <a href="<c:url value="detail?pid=${pro.productID}"/>" style="text-decoration: none; font-weight:500; color: #000;">Xem
                                    chi tiết</a>
                            </button>
                        </div>
                    </div>
		...
		<div class="footer" style="margin-top: 30px;">Copyright © by HeloTeam. Design by HeloTeam
		</div>
	</div>
