...
<body>
<% List<Account> user = (List<Account>) request.getAttribute("users"); %>
 <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #FFC0CB; margin-bottom: 5%;">
            ...
            <div class="collapse navbar-collapse " id="navbarNavDropdown">
                <ul class="navbar-nav mx-5">
                    <li class="nav-item" style="margin-right: 30px;">
                        <a class="nav-link fs-2 text-dark" href="adminpage">Duyệt bài đăng</a>
                    </li>
                    <li class="nav-item" style="margin-right: 30px;">
    ...
    <div class="container reponsive" style=" font-size:1.6rem ;">
        <div class="row">
            <div class="col-sm-12 col-md-12  col-lg-12 col-xl-4 col-12 col-xxl-4 left" style="margin-bottom: 3%;">
                ...
                <div class="left-content">
                    <div style="display: flex;">
                        ...
                        <a href="#" style="text-decoration: none; color: unset;"><div class="fw-bold" style="margin-left: 10px;">Quản lí người dùng</div></a>
                    </div>
                    <div style="display: flex; margin-top: 2%;">
                        <i class="fa-solid fa-note-sticky"></i>
                        <a href="/src/html/manage-topic.html" style="text-decoration: none; color: unset;"><div style="margin-left: 16px;">Quản lí bài đăng</div></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-12  col-lg-12 col-xl-8 col-12 col-xxl-8  right">
                <h1>Danh sách người dùng</h1>
                <div style="display: flex; justify-content: space-between;">
                    <div style="display: flex; width: auto; ">
                        <i class="fa-solid fa-magnifying-glass" style="margin-top: 6px; margin-right: 5px;"></i>
                        <input type="text" placeholder="Tim kiem">
                    </div>
                    <div class="dropdown text-end filter ">
                        <a href="" class="d-block  text-decoration-none dropdown-toggle filter-a" id="dropdownUser1"
                            data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-filter"></i> Bộ
                            lọc</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                     <% for(Account acc : user) { %>
                        <tr>
                        	<td><input type="checkbox" name="foo" onclick="upcount()"><%=acc.getAccountID() %></td>
                            <td> <%=acc.getCustomername() %></td>
                ...
                <div style="margin-bottom: 2%;">
                    <div role="button" class="trash" onclick="deleteCol()"><i class="fa-solid fa-trash-can"></i> Xóa</div>
                </div>
            </div>
        </div>
    </div>
...
<script
    ...
    <script text="javascript">
        ...
        function deleteCol() {
            ...
            $.ajax({
                method: "DELETE",
                url: "http://localhost:8080/spring-demo/api/admin/user",
