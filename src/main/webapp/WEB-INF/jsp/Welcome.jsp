...
<meta http-equiv = "refresh" content = "5; url = listA" />
...
<body>
 <div class="main" style="background-image:linear-gradient(0, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url(<c:url value="/resources/image/background.png"/> ); background-repeat: no-repeat;
    ...
    background-position: center;">
        ...
        <button  style="background-color:transparent ;color:gold; width: 200px; height:46px; font-size:15px; font-weight:500; border:2px solid gold; border-radius: 10px "><a href="<c:url value="listA"/>" style="text-decoration: none">Tới Trang Chủ   <i class="fa-solid fa-forward"></i></a></button>
    	</div>
          <p class="content-des" style="margin:0 10% ; color:gold">Bạn là người yêu quý động vật, hãy đến CutePet nơi cung cấp thông tin các loại thú nuôi. Với đa dạng vật nuôi khác nhau, rất mong các bạn ghé thăm và  tìm kiếm được các con vật bạn yêu thích</p>
        </div>
